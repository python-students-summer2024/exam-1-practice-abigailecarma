...
def bark():
  ...
  """
  dog_name = input("Enter the name of a dog: ").capitalize()
  dog_age = input("Enter the age of a dog: ")
  dog_breed = input("Enter the breed of a dog: ").capitalize()
...
def bark_with_validation():
  ...
  """
  dog_name = input("Enter the name of a dog: ").capitalize()
  if dog_name.isalpha() and len(dog_name) >= 2:
    dog_age = input("Enter the age of a dog: ")
    if dog_age.isdigit() and int(dog_age) >= 0 and int(dog_age) <= 15:
      dog_breed = input("Enter the breed of a dog: ").capitalize()
      if dog_breed == "Schnauzer" or dog_breed == "Terrier" or dog_breed == "Poodle" or dog_breed == "Mastiff":
        print(f'{dog_name}, the {dog_age} year old {dog_breed}, says, "Woof!"')
      else:
        print("Breed error!")
    else:
